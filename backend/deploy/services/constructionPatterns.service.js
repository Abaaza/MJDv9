...
export class ConstructionPatternsService {
    ...
    static calculateConstructionScore(queryFeatures, itemFeatures) {
        ...
        if (queryFeatures.dimensions?.length && itemFeatures.dimensions?.length) {
            const commonDimensions = queryFeatures.dimensions.filter(d => itemFeatures.dimensions?.includes(d));
...
//# sourceMappingURL=constructionPatterns.service.js.map