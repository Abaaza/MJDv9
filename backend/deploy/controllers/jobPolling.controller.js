...
export async function uploadAndProcessBOQ(req, res) {
    try {
        if (!req.file) {
        ...
        const jobId = await convex.mutation(api.priceMatching.createJob, {
            ...
            projectId: req.body.projectId ? toConvexId(req.body.projectId) : undefined,
...
export async function getJobLogs(req, res) {
    try {
        const { jobId } = req.params;
...
//# sourceMappingURL=jobPolling.controller.js.map