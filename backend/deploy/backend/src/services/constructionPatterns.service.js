...
exports.ConstructionPatternsService = void 0;
class ConstructionPatternsService {
    /**
     * Extract construction-specific features from description
     */
    static extractConstructionFeatures(description) {
        const features = {
            keywords: []
        };
        // Extract work type
     ...
     */
    static calculateConstructionScore(queryFeatures, itemFeatures) {
        var _a, _b;
        let score = 0;
        ...
        if (((_a = queryFeatures.dimensions) === null || _a === void 0 ? void 0 : _a.length) && ((_b = itemFeatures.dimensions) === null || _b === void 0 ? void 0 : _b.length)) {
            const commonDimensions = queryFeatures.dimensions.filter(d => { var _a; return (_a = itemFeatures.dimensions) === null || _a === void 0 ? void 0 : _a.includes(d); });
            if (commonDimensions.length > 0) {
                score += 10;
            }
        }
        // Keyword overlap (up to 25 points)
        const commonKeywords = queryFeatures.keywords.filter(k => itemFeatures.keywords.includes(k));
     ...
     */
    static identifyConstructionMethod(description) {
        const methods = [];
     ...
     */
    static isTemporaryWork(description) {
     ...
     */
    static extractLocationContext(description) {
        const locations = [];
...
exports.ConstructionPatternsService = ConstructionPatternsService;
// Construction work type patterns with priority
ConstructionPatternsService.workTypePatterns = [
    // Excavation patterns
    {
...
ConstructionPatternsService.materialSpecs = [
    {
        material: 'concrete',
...
ConstructionPatternsService.dimensionPatterns = [
...
ConstructionPatternsService.spacingPatterns = [
...
ConstructionPatternsService.ratioPatterns = [
