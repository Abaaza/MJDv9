...
exports.extractEmbeddedHeaders = extractEmbeddedHeaders;
exports.isLikelyStandaloneHeader = isLikelyStandaloneHeader;
/**
 ...
 */
function extractEmbeddedHeaders(description) {
 ...
 */
function isLikelyStandaloneHeader(description) {
    if (!description || typeof description !== 'string') {
        return false;
    }
